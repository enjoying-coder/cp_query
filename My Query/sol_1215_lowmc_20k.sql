...
constants AS (
    SELECT
        TIMESTAMP '2025-12-31' AS startDate,
        0 AS min_buy_mc,
        20 AS max_buy_mc,
        0 AS min_token_age,
...
creators AS (
    SELECT 
        ...
        block_time,
        dev
    FROM dune.hdream003.result_result_creators
...
initialTradeTokens_temp AS (
    ...
    LEFT JOIN dune.hdream003.result_result_fake_tokens fake ON ta.token = fake.token
