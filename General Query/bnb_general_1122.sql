...
constants AS (
    SELECT
        TIMESTAMP '2025-10-20' AS startDate,
        0 AS min_buy_mc,
        100 AS max_buy_mc,
        0 AS min_token_age,
        3600 AS max_token_age,
        ...
        1.28 AS aster_price,
        1160 AS bnb_price,
        false AS include_fourmeme,
        false AS include_flap,
        true AS include_binance_exclusive
),
migrations AS (
    SELECT 
        token,
...
WHERE 
    ...
    AND r.last_trade >= TIMESTAMP '2025-10-20'
